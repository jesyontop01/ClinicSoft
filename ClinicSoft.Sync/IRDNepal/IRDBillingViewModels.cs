...
using ClinicSoft.Sync.IRDNepal.Utilities;

namespace ClinicSoft.Sync.IRDNepal.Models
{
    ...
    public class IRD_BillViewModel
    {
        ...
        static string ird_SellerpanNo =  string.Empty;
        ...
        {
            string seller_pan =  string.Empty;
