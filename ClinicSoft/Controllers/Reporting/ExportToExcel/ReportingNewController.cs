    ...
    public class ReportingNewController : Controller
    {
        ...
        public FileContentResult ExportToExcelDepositBalance()
        {
            try
            {
                ...
                columnamesForDepositBalance.Add(new ColumnMetaData() { ColName = "LPNo", DisplaySeq = 1, ColDisplayName = "Hospital Number", });
        ...
        public FileContentResult ExportToExcelCreditSummary(DateTime FromDate, DateTime ToDate)
        {
            try
            {
                ...
                columnamesForCreditSummary.Add(new ColumnMetaData() { ColName = "LPNo", DisplaySeq = 3, ColDisplayName = "Hospital Number", });
        ...
        public FileContentResult ExportToExcelReturnBills(DateTime FromDate, DateTime ToDate)
        {
            try
            {
                ...
                columnamesForReturnBill.Add(new ColumnMetaData() { DisplaySeq = 2, ColName = "LPNo", ColDisplayName = "Hospital Number", });
        ...
        public FileContentResult ExportToExcelBilDocDeptItemSummary(DateTime FromDate, DateTime ToDate, int ProviderId, string SrvDeptName)
        {
            try
            {
                ...
                columnamesForExcel.Add(new ColumnMetaData() { DisplaySeq = 2, ColName = "LPNo", ColDisplayName = "Patient Code" });
