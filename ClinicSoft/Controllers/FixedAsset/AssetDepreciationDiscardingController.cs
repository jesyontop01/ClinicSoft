    ...
    public class AssetDepreciationDiscardingController : CommonController
    {
        ...
        public IActionResult PutAssetDepreciation()
        {
            ...
            try
            {
                ...
                inventoryDbContext.Entry(temp).Property(x => x.Entity.AssetDeprnMethodId).IsModified = true;
                inventoryDbContext.Entry(temp).Property(x => x.Entity.FiscalYearId).IsModified = true;
                inventoryDbContext.Entry(temp).Property(x => x.Entity.DepreciationAmount).IsModified = true;
                inventoryDbContext.Entry(temp).Property(x => x.Entity.Rate).IsModified = true;
                inventoryDbContext.Entry(temp).Property(x => x.Entity.StartDate).IsModified = true;
                inventoryDbContext.Entry(temp).Property(x => x.Entity.EndDate).IsModified = true;
        ...
        public IActionResult UpdateAssetScrapDetails()
        {
            ...
            try
            {
                ...
                inventoryDbContext.Entry(temp).Property(x => x.Entity.ScrapAmount).IsModified = true;
                inventoryDbContext.Entry(temp).Property(x => x.Entity.ScrapRemarks).IsModified = true;
                inventoryDbContext.Entry(temp).Property(x => x.Entity.ScrapCancelRemarks).IsModified = true;
                inventoryDbContext.Entry(temp).Property(x => x.Entity.IsAssetScraped).IsModified = true;
