    ...
    public class AssetMaintenanceController : CommonController
    {
        ...
        public IActionResult PutAssetRequiredMaintenance()
        {
            ...
            try
            {
                ...
                inventoryDbContext.Entry(temp).Property(x => x.Entity.IsMaintenanceRequired).IsModified = true;
                ...
                inventoryDbContext.Entry(temp).Property(x => x.Entity.Performance).IsModified = true;
        ...
        public IActionResult PutAssetFaultResolvedDetails()
        {
            ...
            try
            {
                ...
                inventoryDbContext.Entry(temp).Property(x => x.Entity.IsFaultResolved).IsModified = true;
                inventoryDbContext.Entry(temp).Property(x => x.Entity.FaultResolvedDate).IsModified = true;
                inventoryDbContext.Entry(temp).Property(x => x.Entity.FaultResolvedRemarks).IsModified = true;
                inventoryDbContext.Entry(temp).Property(x => x.Entity.ModifiedBy).IsModified = true;
                inventoryDbContext.Entry(temp).Property(x => x.Entity.ModifiedOn).IsModified = true;
        ...
        public IActionResult PutRepairStatus()
        {
            ...
            try
            {
                ...
                inventoryDbContext.Entry(temp).Property(x => x.Entity.IsUnderMaintenance).IsModified = true;
                inventoryDbContext.Entry(temp).Property(x => x.Entity.IsMaintenanceRequired).IsModified = true;
                inventoryDbContext.Entry(temp).Property(x => x.Entity.Performance).IsModified = true;
                inventoryDbContext.Entry(temp).Property(x => x.Entity.ModifiedBy).IsModified = true;
                inventoryDbContext.Entry(temp).Property(x => x.Entity.ModifiedOn).IsModified = true;
        ...
        public IActionResult PutAssetServiceDetails()
        {
            ...
            try
            {
                ...
                inventoryDbContext.Entry(temp).Property(x => x.Entity.ServiceDate).IsModified = true;
                inventoryDbContext.Entry(temp).Property(x => x.Entity.ServiceRemarks).IsModified = true;
                inventoryDbContext.Entry(temp).Property(x => x.Entity.ServiceCompleteDate).IsModified = true;
                inventoryDbContext.Entry(temp).Property(x => x.Entity.ServiceCompleteRemarks).IsModified = true;
                inventoryDbContext.Entry(temp).Property(x => x.Entity.ModifiedBy).IsModified = true;
                inventoryDbContext.Entry(temp).Property(x => x.Entity.ModifiedOn).IsModified = true;
        ...
        public IActionResult AssetFaultUpdate()
        {
            ...
            try
            {
                ...
                inventoryDbContext.Entry(temp).State = EntityState.Modified;
                inventoryDbContext.Entry(temp).Property(x => x.Entity.FixedAssetStockId).IsModified = false;
                inventoryDbContext.Entry(temp).Property(x => x.Entity.CreatedBy).IsModified = false;
                inventoryDbContext.SaveChanges();
            ...
            try
            {
                ...
                using (var dbTransaction = inventoryDbContext.Database.BeginTransaction())
                {
                    try
                    {
                        ...
                        inventoryDbContext.Entry(temp).State = EntityState.Modified;
                        inventoryDbContext.Entry(temp).Property(x => x.Entity.ItemId).IsModified = false;
                        inventoryDbContext.Entry(temp).Property(x => x.Entity.CreatedOn).IsModified = false;
                        inventoryDbContext.Entry(temp).Property(x => x.Entity.CreatedBy).IsModified = false;
                        inventoryDbContext.Entry(temp).Property(x => x.Entity.GoodsReceiptItemId).IsModified = false;

                        inventoryDbContext.Entry(temp).Property(x => x.Entity.AssetsLocation).IsModified = false;
                        inventoryDbContext.Entry(temp).Property(x => x.Entity.WarrantyExpiryDate).IsModified = false;
                        inventoryDbContext.Entry(temp).Property(x => x.Entity.ModelNo).IsModified = false;
                        inventoryDbContext.Entry(temp).Property(x => x.Entity.SerialNo).IsModified = false;
                        inventoryDbContext.Entry(temp).Property(x => x.Entity.BuildingBlockNumber).IsModified = false;
                        inventoryDbContext.Entry(temp).Property(x => x.Entity.Floors).IsModified = false;
                        inventoryDbContext.Entry(temp).Property(x => x.Entity.RoomNumber).IsModified = false;
                        inventoryDbContext.Entry(temp).Property(x => x.Entity.RoomPosition).IsModified = false;
                        inventoryDbContext.Entry(temp).Property(x => x.Entity.StoreId).IsModified = false;

                        inventoryDbContext.Entry(temp).Property(x => x.Entity.ManufactureDate).IsModified = true;
                        inventoryDbContext.Entry(temp).Property(x => x.Entity.TotalLife).IsModified = true;
                        inventoryDbContext.Entry(temp).Property(x => x.Entity.Performance).IsModified = true;
                        inventoryDbContext.Entry(temp).Property(x => x.Entity.YearOfUse).IsModified = true;
                        inventoryDbContext.Entry(temp).Property(x => x.Entity.IsActive).IsModified = true;
                        inventoryDbContext.Entry(temp).Property(x => x.Entity.IsMaintenanceRequired).IsModified = true;
                        inventoryDbContext.SaveChanges();
