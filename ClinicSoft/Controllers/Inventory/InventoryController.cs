...
using ClinicSoft.ViewModel.Procurement;
...
namespace ClinicSoft.Controllers
{
    ...
    public class InventoryController : CommonController
    {
        ...
        public InventoryController(IWebHostEnvironment  env, IOptions<MyConfiguration> _config, IVerificationService verificationService, IInventoryReceiptNumberService receiptNumberService) : base(_config)
        {
