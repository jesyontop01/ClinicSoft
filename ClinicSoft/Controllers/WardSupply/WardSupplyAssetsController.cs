...
using ClinicSoft.ViewModel; //swapnil-2-april-2021
...
using ClinicSoft.ViewModel.FixedAsset; //swapnil-2-april-2021
                ...
                using (var dbContextTransaction = wardSupplydbcontext.Database.BeginTransaction())
                {
                    try
                    {
                        ...
                        foreach (var item in dispatchItems)
                        {
                            ...
                            wardSupplydbcontext.Entry(temp).Property(x => x.Entity.SubStoreId).IsModified = true;
                            wardSupplydbcontext.SaveChanges();
                        }
                        ...
                        foreach (var requisitionItemId in allUniqueRequisitionItemIds)
                        {
                            ...
                            wardSupplydbcontext.Entry(temp).Property(x => x.Entity.ReceivedQuantity).IsModified = true;
                            wardSupplydbcontext.Entry(temp).Property(x => x.Entity.PendingQuantity).IsModified = true;
                            wardSupplydbcontext.Entry(temp).Property(x => x.Entity.RequisitionItemStatus).IsModified = true;
                            wardSupplydbcontext.Entry(temp).Property(x => x.Entity.ModifiedBy).IsModified = true;
                            wardSupplydbcontext.Entry(temp).Property(x => x.Entity.ModifiedOn).IsModified = true;
                            wardSupplydbcontext.SaveChanges();
                        }
                        ...
                        wardSupplydbcontext.Entry(temp1).Property(x => x.Entity.RequisitionStatus).IsModified = true;
                        wardSupplydbcontext.SaveChanges();
