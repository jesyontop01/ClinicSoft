...
export class VaccinationStickerComponent {
    ...
    //         if (res.Status = "OK") {
    //             this.VaccStickerDetails.LPNo = res.Results.LPNo;
    ...
    // Hospital No: `+ this.VaccStickerDetails.LPNo + `
    // Age/Sex: `+ this.ageSex + `
   ...
   .dptdesc-left {
    ...
    .opd-qrcode {
      ...
      margin: 8px 15px 0 0;
        ...
        PrinterName += this.stickerDetail.LPNo;
    ...
    public PrintDotMatrix() {
        ...
        finalDataToPrint += "Hosp. No:" + this.stickerDetail.LPNo + " " + "Vacc.Reg.No:" + this.stickerDetail.VaccinationRegNo + nline;
