...
export class PHRMProvisionalReturnComponent {
        ...
        switch ($event.Action) {
            ...
            case "view": {
                if ($event.Data != null) {
                    ...
                    this.currentPatient.LPNo = CreditData.LPNo;
    ...
    MakeReceipt() {
        ...
        // headerStr += CommonFunctions.GetTextFIlledToALength('Hosp.No:' + this.receipt.Patient.LPNo, headerLeftColLen) + CommonFunctions.GetTextFIlledToALength('(' + this.receipt.localReceiptdate + ')', this.headerRightColLen) + this.nline;
