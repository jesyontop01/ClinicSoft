...
export class ImagingDLService {
   public options =  {
    ...
    public GetFilmTypeData(){
        return this.http.get<any>('/clinicsoft/api/radiology?reqType=getFilmTypeData', this.options);
    }
    ...
    public GetItemsByType(typeId: number) {
        return this.http.get<any>("/clinicsoft/api/Master?type=imagingitem&inputValue=" + typeId, this.options);
    }
    //imaging-requistion-component
    //get patinet's list of requisition items
    public GetPatientImagingRequisitions(patientId: number, orderStatus: string) {
        return this.http.get<any>('/clinicsoft/api/radiology?patientId=' + patientId + '&orderStatus=' + orderStatus
    ...
    public GetImagingTypes() {
        return this.http.get<any>('/clinicsoft/api/radiology?reqType=getImagingTypes', this.options);
    }
    
     //gets dicom Image list
    public GetDicomImageList(PatientStudyId) {
        return this.http.get<any>('/clinicsoft/api/radiology?reqType=get-dicom-image-list&PatientStudyId=' + PatientStudyId, this.options);
    }
    ...
    public GetImagingReqsAndReportsByStatus(reqOrderStatus: string, reportOrderStatus: string, typeList: string, fromDate:string, toDate:string) {
        return this.http.get<any>('/clinicsoft/api/radiology?reqType=getRequisitionsList'
    ...
    public GetImagingReqsAndReportsByStatus_Old(reqOrderStatus: string, reportOrderStatus: string, billingStatus: string) {
        return this.http.get<any>('/clinicsoft/api/radiology?reqType=reqNReportListByStatus'
            + '&reqOrderStatus=' + reqOrderStatus
            + '&reportOrderStatus=' + reportOrderStatus
    ...
    public GetPatientReports(patientId: number, reportOrderStatus) {
        return this.http.get<any>('/clinicsoft/api/radiology?patientId=' + patientId
            + '&reqType=imagingResult'
            + '&reportOrderStatus=' + reportOrderStatus, this.options);
    }

    public GetPatientVisitReports(patientVisitId: number) {
        return this.http.get<any>('/clinicsoft/api/radiology?reqType=imagingResult-visit&patientVisitId=' + patientVisitId, this.options);
    }

    //imaging-result.component
    //get list of reports of selected patient using orderStatus
    public GetAllImagingReports(reportOrderStatus: string, frmDate: string, toDate: string, typeStr: string) {
        return this.http.get<any>('/clinicsoft/api/radiology?&reqType=allImagingReports'
    ...
    public GetImagingReportByRequisitionId(requisitionId: number) {
        return this.http.get<any>('/clinicsoft/api/radiology?&reqType=imagingReportByRequisitionId'
            + '&requisitionId=' + requisitionId, this.options);
    }
    //gets the types of imaging items
    public GetImagingType() {
        return this.http.get<any>('/clinicsoft/api/radiology?reqType=getImagingType', this.options);
    }
    //getting report for patient view..(used in view-report.component)
    public GetEmpPreference(employeeId: number) {
        return this.http.get<any>("/clinicsoft/api/radiology?reqType=employeePreference&employeeId=" + employeeId, this.options)
    }
    ...
    public GetImagingReportContent(isRequisitionReport, id) {
        try {
            return this.http.get<any>("/clinicsoft/api/radiology?reqType=reportDetail&isRequisitionReport=" + isRequisitionReport + "&id=" + id, this.options)
        } catch (exception) {
            throw exception;
        }
    }
    //public GetReportingDoctor(imagingTypeId: number) {
    //    return this.http.get<any>("/clinicsoft/api/radiology?reqType=reporting-doctor&imagingTypeId=" + imagingTypeId, this.options)
    //}
    public GetAllReportTemplates() {
        return this.http.get<any>("/clinicsoft/api/radiology?reqType=all-report-templates", this.options)
    }

    public GetDoctorList() {
        return this.http.get<any>("/clinicsoft/api/radiology?reqType=doctor-list", this.options)
    }
    //Get  scanned imaging files list for add to report
    //get data from pac server
    GetImgFileList(fromDate: string, toDate: string) {
        try {
            return this.http.get<any>("/clinicsoft/api/radiology?reqType=imgingFileListFromPACS&fromDate=" + fromDate + "&toDate=" + toDate, this.options)
        } catch (exception) {
            throw exception;
        }
    }
    ...
    GetReportTextByImagingReportId(ImagingReportId) {
        try {
            return this.http.get<any>("/clinicsoft/api/radiology?reqType=reportTextByRPTId&imagingReportId=" + ImagingReportId, this.options)
        } catch (exception) {
            throw exception;
        }
    }
    ...
    GetDICOMViewerByImgRptId(ImagingReportId, PatientStudyId) {
        try {
            return this.http.get<any>("/clinicsoft/api/radiology?reqType=dicomViewerUrl&imagingReportId=" + ImagingReportId + "&PatientStudyId=" + PatientStudyId, this.options)
        } catch (exception) {
            throw exception;
        }
    }
    ...
    public PostRequestItems(reqItemList: Array<ImagingItemRequisition>) {
        ...
        return this.http.post<any>('/clinicsoft/api/Radiology?reqType=postRequestItems', data, this.options);
    }
    ...
    public PostItemReport(itemReport: ImagingItemReport) {
        ...
        return this.http.post<any>('/clinicsoft/api/Radiology?reqType=postReport', data, this.options);
    }
    //imaging-report.component
    //post report
    public PostImgItemReport(formData: any) {
        try {
            return this.http.post<any>("/clinicsoft/api/Radiology?reqType=postReport", formData);
    ...
    PostPatientStudy(reportData) {
        try {
            return this.http.post<any>("/clinicsoft/api/Radiology?reqType=postPatientStudy", reportData, this.options);
        } catch (exception) {
            throw exception;
        }
  }
  ...
  public SendEmail(formData: any) {
    let data = formData;
    try {
      return this.http.post<any>("/clinicsoft/api/Radiology?reqType=sendEmail", data, this.options)
    } catch (exception) {
      throw exception;
    }
  }
    ...
    public PutImagingReqsBillingStatus(requisitionIds: number[], billingStatus: string) {
        ...
        return this.http.put<any>('/clinicsoft/api/Radiology?reqType=billingStatus' + '&billingStatus=' + billingStatus, data, this.options)
    }
    ...
    public PutImgItemReport(formData: any) {
        try {
            return this.http
                .put<any>('/clinicsoft/api/Radiology?reqType=updateImgReport'
                , formData);
        } catch (exception) {
            throw exception;
        }
    ...
    public PutPatientStudy(reportData) {
        try {
            return this.http
                .put<any>('/clinicsoft/api/Radiology?reqType=updatePatientStudy'
    ...
    public DeleteImgsByImagingRptId(reportModelData) {
        try {
            ...
            return this.http.put<any>('/clinicsoft/api/Radiology?reqType=deleteRptImages', data, this.options);
        } catch (exception) {
            throw exception;
        }
    }
    ...
    public GetRadiologyBillingItems() {
        return this.http.get<any>("/clinicsoft/api/Billing?reqType=department-items&departmentName=radiology", this.options)
    }
    ...
    public CancelBillRequest(data: string) {
        return this.http.put<any>("/clinicsoft/api/Billing?reqType=cancelInpatientBillRequest", data, this.options);
    }

    public PutDoctor(id: number,providerName: string, reqId: number) {
        let data = JSON.stringify(reqId);
        return this.http.put<any>('/clinicsoft/api/Radiology?reqType=UpdateDoctor' + '&providerId=' + id + '&providerName=' + providerName,data, this.options);
    }
  ...
  public PutScannedDetails(reqId: number) {
    try {
      return this.http
        .put<any>('/clinicsoft/api/Radiology?reqType=updateRadPatScanData', reqId, this.options);
    } catch (exception) {
      throw exception;
    }
  }
