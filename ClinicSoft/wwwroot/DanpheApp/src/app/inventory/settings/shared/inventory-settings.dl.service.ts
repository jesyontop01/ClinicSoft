...
export class InventorySettingDLService {
  ...
  public GetAccountHead(ShowIsActive: boolean) {
    return this.http.get<any>("/clinicsoft/api/InventorySettings?reqType=GetAccountHead&ShowIsActive=" + ShowIsActive);
  }
  // getMappedledgerlist
  public getMappedledgerlist(ledgerType) {
    return this.http.get<any>("/clinicsoft/api/Accounting?reqType=get-mapped-ledger-list&ledgerType=" + ledgerType);
  }
  ...
  public GetItemSubCategory() {
    return this.http.get<any>("/clinicsoft/api/InventorySettings?reqType=GetItemSubCategory");
  }
  ...
  public getAllRoles() {
    return this.http.get<any>("/clinicsoft/api/inventorySettings/getAllRoles");
  }
  ...
  public PostTerms(CurrentData) {
    ...
    return this.http.post<any>("/clinicsoft/api/InventorySettings?reqType=PostInventoryTerms", data, this.options);
  }
  ...
  public PostItemSubCategory(CurrentItemSubCategory) {
    ...
    return this.http.post<any>("/clinicsoft/api/InventorySettings?reqType=AddItemSubCategory", data, this.options);
  }
  ...
  public PutItemSubCategory(itemsubcategory) {
    ...
    return this.http.put<any>("/clinicsoft/api/InventorySettings?reqType=UpdateItemSubCategory", itemsubcategory, this.options);
  }
  ...
  public PutTerms(CurrentData) {
    let data = JSON.stringify(CurrentData);
    return this.http.put<any>("/clinicsoft/api/InventorySettings?reqType=UpdateInventoryTerms", CurrentData, this.options);
  }
}
