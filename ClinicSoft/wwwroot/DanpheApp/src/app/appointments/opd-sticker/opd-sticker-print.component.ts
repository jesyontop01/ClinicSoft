...
export class PrintStickerComponent {
  ...
  CallBackStickerOnly(res) {
    if (res.Status = "OK" && res.Results.length != 0) {
      this.OpdStickerDetails.LPNo = res.Results[0].LPNo;
...
Hospital No: `+ this.OpdStickerDetails.LPNo + `
Age/Sex: `+ this.ageSex + `
...
Address: `+ this.OpdStickerDetails.Address;
  ...
  printStickerServer() {
   ...
   .dptdesc-left {
    ...
    PrinterName += this.OpdStickerDetails.LPNo;
  ...
  public PrintDotMatrix() {
    ...
    finalDataToPrint += "Hosp. No:" + this.OpdStickerDetails.LPNo + " " + (this.OpdStickerDetails.PhoneNumber ? "Ph:" + this.OpdStickerDetails.PhoneNumber : "") + nline;
