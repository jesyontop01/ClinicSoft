...
export class BIL_Print_Invoice_Discharge_Component {
    ...
    public MakeReceipt() {
        ...
        headerStr += CommonFunctions.GetTextFIlledToALength('Hospital No: ' + this.invoice.PatientInfo.LPNo, headerLeftColLen) + CommonFunctions.GetTextFIlledToALength('IP No: ' + this.ipdNumber, this.headerRightColLen) + this.nline;
