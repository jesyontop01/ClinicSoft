...
export class DepositReceiptComponent {
  ...
  public MakeReceipt() {
    ...
    headerStr += CommonFunctions.GetTextFIlledToALength('Hospital No: ' + this.deposit.LPNo, headerLeftColLen) + (this.deposit.InpatientpNumber ? CommonFunctions.GetTextFIlledToALength('Inpatient No: ' + this.deposit.InpatientpNumber, this.headerRightColLen) : '') + nline;
