...
export class Bil_Print_Invoice_DefaultComponent {
  ...
  public MakeReceipt() {
    ...
    headerStr += CommonFunctions.GetTextFIlledToALength('Hospital No:' + this.invoice.PatientInfo.LPNo, headerLeftColLen) + CommonFunctions.GetTextFIlledToALength('Invoice Date: ' + moment(this.invoice.InvoiceInfo.TransactionDate).format("YYYY-MM-DD"), this.headerRightColLen) + this.nline;
...
Hospital No: `+ '[' + this.invoice.PatientInfo.LPNo + ']' + `
