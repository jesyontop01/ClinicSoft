...
export class BillingReceiptComponent_Old {
  ...
  public MakeReceipt() {
    ...
    headerStr += CommonFunctions.GetTextFIlledToALength('Hospital No:' + this.receipt.Patient.LPNo, headerLeftColLen) + CommonFunctions.GetTextFIlledToALength('Invoice Date: ' + moment(this.receipt.BillingDate).format("YYYY-MM-DD"), this.headerRightColLen) + this.nline;
...
Hospital No: `+ '[' + this.receipt.Patient.LPNo + ']' + `
