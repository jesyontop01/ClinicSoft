...
export class BIL_Print_ProvisionalSlip_Component {
  ...
  public MakeReceipt(): string {
    ...
    headerStr += CommonFunctions.GetTextFIlledToALength('Hospital No:' + this.ProvisionalSlipDetails.LPNo, headerLeftColLen) + CommonFunctions.GetTextFIlledToALength('Print Date: ' + moment(this.CurrentDate).format("YYYY-MM-DD"), this.headerRightColLen) + this.nline;
