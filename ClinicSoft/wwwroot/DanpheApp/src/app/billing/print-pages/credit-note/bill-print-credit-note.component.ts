...
export class Bill_Print_CreditNote_Component {
  ...
  public MakeReceipt() {
    ...
    headerStr += CommonFunctions.GetTextFIlledToALength('Hospital No: ' + this.Patient.LPNo, headerLeftColLen) + CommonFunctions.GetSpaceRepeat(headerLeftColLen) + this.nline;
