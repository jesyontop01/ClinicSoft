...
export class UpgradeComponent {
  ...
  public selectedBedInfo: { PatientAdmissionId, PatientId, PatientVisitId, MSIPAddressInfo, LPNo, Name, BedInformation: { BedId, WardId, PatientBedInfoId, Ward, BedFeature, BedCode, BedNumber, BedFeatureId, AdmittedDate, StartedOn } };
  @Output("upgrade")
