...
export class AdmittedListComponent {
  ...
  public selectedBedInfo: { PatientAdmissionId, PatientId, PatientVisitId, MSIPAddressInfo, LPNo, DischargedDate, Name, AdmittingDoctor, BedInformation: { BedId, PatientBedInfoId, Ward, BedFeature, BedCode, BedNumber, BedFeatureId, AdmittedDate, WardId, StartedOn } };
  ...
  AdmittedListGridActions($event: GridEmitModel) {
    ...
    switch ($event.Action) {
      ...
      case "billdetail": {
        ...
        //this.selPatient.LPNo = data.LPNo;
  ...
  MapVisitGenericSticker(admInfo): VisitGenericStickerModel {
    ...
    retData.HospitalNo = admInfo.LPNo;
    retData.PatientFullName = admInfo.Name;
    retData.BarCodeNum = admInfo.LPNo;
