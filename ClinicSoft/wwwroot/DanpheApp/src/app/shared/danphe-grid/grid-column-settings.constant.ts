...
export default class GridColumnSettings {
  ...
  //   { headerName: "Hospital No.", field: "LPNo", width: 100 },
  ...
  PatientSearch = [
    { headerName: "LPNo", field: "LPNo", width: 160 },
  ...
  //    { headerName: "LPNo", field: "LPNo", width: 150 },
  ...
  //    { headerName: "Hospital No", field: "LPNo", width: 120 },
  ...
  static VisitSearch = [
    ...
    { headerName: "Hospital No.", field: "LPNo", width: 140 },
  ...
  static BillPendingOrderSearch = [
    ...
    { headerName: "LPNo", field: "Patient.LPNo", width: 100 },
  ...
  static BillCancelSearch = [
    { headerName: "LPNo", field: "LPNo", width: 170 },
  ...
  static ProvisionalCancelSearch = [
    { headerName: "LPNo", field: "LPNo", width: 70 },
    { headerName: "Patient Name.", field: "ShortName", width: 160 },
    {
      headerName: "Age/Sex",
      field: "",
  ...
  static ImagingRequisitionListSearch = [
    ...
    { headerName: "LPNo", field: "Patient.LPNo", width: 90 },
...
return template;
  ...
  static ImagingReportListSearch = [
    ...
    { headerName: "LPNo", field: "LPNo", width: 90 },
  ...
  //   { headerName: "LPNo", field: "LPNo", width: 125 },
  //   { headerName: "Patient Name", field: "PatientName", width: 150 },
  ...
  static WardBilling = [
    { headerName: "Hospital No.", field: "LPNo", width: 90 },
  ...
  //   { headerName: "Hospital No.", field: "LPNo", width: 80 },
  ...
  static RadiologyEditDoctorItemList = [
    ...
    { headerName: "Hospital No", field: "LPNo", width: 70 },
    { headerName: "Patient Name", field: "PatientName", width: 120 },
    {
      headerName: "Age/Sex",
      width: 60,
  ...
  static NurOPDList = [
    ...
    { headerName: "LPNo", field: "LPNo", width: 120 },
    {
      headerName: "Patient Name",
      field: "ShortName",
      width: 160,
  ...
  static DoctorAppointmentList = [
    { headerName: "Hospital No.", width: 100, field: "Patient.LPNo" },
  ...
  static AdmittedAppointmentList = [
    { headerName: "Hospital No.", width: 80, field: "LPNo" },
  ...
  static DuplicateInvoiceList = [
    ...
    { headerName: "Hospital No.", field: "LPNo" },
 ...
 <a danphe-grid-action="SelectedQuotation" class="grid-action"> Selected Quotation </a>`;
  ...
  static SettlementDuplicateColumns = [
    { headerName: "Hospital No.", field: "Patient.LPNo" },
