...
export class EmergencyStickerComponent {
  ...
  CallBackStickerOnly(res) {
    if (res.Status = "OK" && res.Results.length != 0) {
      this.stickerDetail.LPNo = res.Results[0].LPNo;
      ...
      Hospital No: `+ this.stickerDetail.LPNo + `
      Age/Sex: `+ this.ageSex + `
  ...
  public PrintDotMatrix() {
    ...
    finalDataToPrint += "Hosp. No:" + this.stickerDetail.LPNo + " " + "Ph:" + this.stickerDetail.PhoneNumber + nline;
