...
export class GOVINSPatientWiseClaimsComponent {
  ...
  public patientListFormatter(data: any): string {
    let html: string = "";
    html = "<font size=03>" + "Patient No: [" + data["LPNo"] + "]" + "</font>&nbsp;&nbsp;<font size=03>NSHI No:[" + data["Ins_NshiNumber"] + "]</font>&nbsp;&nbsp;<font color='blue'; size=03 ><b>" + data["ShortName"] +
      "</b></font>";
    return html;
  }
  ...
  AssignPatientInfo(claimObj: any) {
    ...
    this.selPatient.LPNo = claimObj.LPNo;
