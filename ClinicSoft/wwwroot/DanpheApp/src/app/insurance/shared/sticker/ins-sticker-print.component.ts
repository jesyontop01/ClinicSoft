...
Hospital No: `+ this.insStickerDetails.LPNo + `
Age/Sex: `+ this.ageSex + `
...
Address: `+ this.insStickerDetails.Address;
  ...
  printStickerServer() {
   ...
   .dptdesc-left {
    ...
    var printFileName = "INS_Sticker_" + this.insStickerDetails.LPNo;
  ...
  public PrintDotMatrix() {
    ...
    finalDataToPrint += "Hosp. No:" + this.insStickerDetails.LPNo + " " + (this.insStickerDetails.PhoneNumber ? "Ph:" + this.insStickerDetails.PhoneNumber : "") + nline;
