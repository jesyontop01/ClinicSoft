...
namespace ClinicSoft.Core.Caching
{
    ...
    public class DanpheCache
    {
        ...
        private static IMemoryCache globalMemcache;
        ...
        public DanpheCache(string connectionString, int cacheExpMinutes)
        {
            ...
            globalMemcache = new MemoryCache(cacheOptions);
            cacheExpiryMinutes = cacheExpMinutes;
        }
        ...
        //public static bool Add(string key, object value, DateTimeOffset absoluteExpiration)
        //{
        //    return (bool)globalMemcache.Set(key, value, new MemoryCacheEntryOptions
        //    {
        //        AbsoluteExpiration = absoluteExpiration
        //    });
        //}
        public static bool Add(string key, object value, DateTimeOffset absoluteExpiration)
        {
            try
            {
                globalMemcache.Set(key, value, new MemoryCacheEntryOptions
                {
                    AbsoluteExpiration = absoluteExpiration
                });

                // Cache item was added successfully
                return true;
            }
            catch (Exception ex)
            {
                ...
                // Cache item was not added due to an exception
                return false;
            }
        }
        ...
        //    return (bool)globalMemcache.Set(key, value, new MemoryCacheEntryOptions
        //    {
        //        AbsoluteExpiration = DateTimeOffset.Now.AddMinutes(absoluteExpiryMinsFromNow)
        //    });
        //}

        public static void Add(string key, object value, int absoluteExpiryMinsFromNow)
        {
            try
            {
                globalMemcache.Set(key, value, new MemoryCacheEntryOptions
