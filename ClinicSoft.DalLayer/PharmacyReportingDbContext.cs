...
namespace ClinicSoft.DalLayer
{
    public class PharmacyReportingDbContext : DbContext
    {
        ...
        public List<PHRMItemWiseStockReportModel> PHRMItemWiseStockReport()
        {
            var phrmInvoice = new List<PHRMItemWiseStockReportModel>();
            ...
            using (var connection = Database.GetDbConnection() as SqlConnection)
            {
                if (connection != null)
                {
                    ...
                    {
                        command.CommandText = "SP_PHRMReport_ItemWiseStockReport";
                        ...
                        using (var reader = command.ExecuteReader())
                        {
                            while (reader.Read())
                            {
                                var phrmDetail = new PHRMItemWiseStockReportModel
                                {
