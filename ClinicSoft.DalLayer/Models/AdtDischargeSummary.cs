...
{
    public partial class AdtDischargeSummary
    {
        ...
        public virtual EmpEmployee? Anaesthetists { get; set; }
        public virtual EmpEmployee Consultant { get; set; } = null!;
        public virtual EmpEmployee CreatedByNavigation { get; set; } = null!;
        public virtual AdtDischargeType DischargeType { get; set; } = null!;
        public virtual EmpEmployee DoctorIncharge { get; set; } = null!;
        public virtual EmpEmployee? ModifiedByNavigation { get; set; }
        public virtual ClnNote? Notes { get; set; }
        public virtual PatPatientVisit PatientVisit { get; set; } = null!;
        public virtual EmpEmployee? ResidenceDr { get; set; }
    }
}
