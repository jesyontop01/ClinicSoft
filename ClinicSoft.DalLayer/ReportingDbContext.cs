...
namespace ClinicSoft.DalLayer
{
    public class ReportingDbContext : DbContext
    {
        ...
        public DataTable SchemeWiseDiscountReport(DateTime FromDate, DateTime ToDate, int MembershipTypeId)
        {
            List<SqlParameter> paramList = new List<SqlParameter>() {  new SqlParameter("@FromDate", FromDate),
                            new SqlParameter("@ToDate", ToDate),
        ...
        public DataTable EHSBillReport(DateTime FromDate, DateTime ToDate, string ServiceDepartmentName, string ItemName, int? AssignedToDoctorId, int? ReferredByDoctorId,int? UserId)
        {
            List<SqlParameter> paramList = new List<SqlParameter>() {  new SqlParameter("@FromDate", FromDate),
                           new SqlParameter("@ToDate", ToDate),
                           new SqlParameter("@ServiceDepartmentName", ServiceDepartmentName == null ? string.Empty : ServiceDepartmentName),
                           new SqlParameter("@ItemName", ItemName == null ? string.Empty : ItemName),
                           new SqlParameter("@ProviderId", AssignedToDoctorId),
                           new SqlParameter("@RequestedBy", ReferredByDoctorId),
        ...
        public List<InvoiceDetailsModel> InvoiceDetails(DateTime fromDate, DateTime toDate)
        {
            var invoiceDetails = new List<InvoiceDetailsModel>();
            ...
            using (var connection = Database.GetDbConnection() as SqlConnection)
            {
                if (connection != null)
                {
                    ...
                    {
                        command.CommandText = "SP_IRD_InvoiceDetails";
                        ...
                        using (var reader = command.ExecuteReader())
                        {
                            while (reader.Read())
                            {
                                var invoiceDetail = new InvoiceDetailsModel
                                {
        ...
        public List<PhrmInvoiceDetails> PhrmInvoiceDetails(DateTime fromDate, DateTime toDate)
        {
            var phrmInvoice = new List<PhrmInvoiceDetails>();
            ...
            using (var connection = Database.GetDbConnection() as SqlConnection)
            {
                if (connection != null)
                {
                    ...
                    using (var command = connection.CreateCommand())
                    {
                        command.CommandText = "SP_IRD_PHRM_InvoiceDetails";
                        command.CommandType = CommandType.StoredProcedure;
                        ...
                        using (var reader = command.ExecuteReader())
                        {
                            while (reader.Read())
                            {
                                var phrmDetail = new PhrmInvoiceDetails
                                {
        ...
        {
            var phrmInvoice = new List<SqlAuditModel>();
            ...
            using (var connection = Database.GetDbConnection() as SqlConnection)
            {
                if (connection != null)
                {
                    ...
                    using (var command = connection.CreateCommand())
                    {
                        command.CommandText = "SP_Danphe_SQLAudit";
                        command.CommandType = CommandType.StoredProcedure;
                        ...
                        using (var reader = command.ExecuteReader())
                        {
                            while (reader.Read())
                            {
                                var phrmDetail = new SqlAuditModel
                                {
        ...
        {
            var phrmInvoice = new List<AuditTrailModel>();
            ...
            using (var connection = Database.GetDbConnection() as SqlConnection)
            {
                if (connection != null)
                {
                    ...
                    using (var command = connection.CreateCommand())
                    {
                        ...
                        command.CommandText = "SP_Danphe_Audit_List";
                        command.CommandType = CommandType.StoredProcedure;
                        ...
                        using (var reader = command.ExecuteReader())
                        {
                            while (reader.Read())
                            {
                                var phrmDetail = new AuditTrailModel
                                {
